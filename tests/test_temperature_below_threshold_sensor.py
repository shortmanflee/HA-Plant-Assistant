"""Tests for temperature below threshold hours sensor."""
...
async def test_temperature_below_threshold_sensor_init(mock_hass):
    ...
    assert sensor._attr_name == "Test Garden Temperature Below Threshold Hours"
    assert (
        sensor._attr_unique_id
        == f"{DOMAIN}_test_entry_123_test_garden_temperature_below_threshold_hours"
    )
